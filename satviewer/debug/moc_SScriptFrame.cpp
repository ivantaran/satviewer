...
struct qt_meta_stringdata_SScriptFrame_t {
    QByteArrayData data[3];
    char stringdata[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_SScriptFrame_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_SScriptFrame_t qt_meta_stringdata_SScriptFrame = {
    {
QT_MOC_LITERAL(0, 0, 12),
QT_MOC_LITERAL(1, 13, 6),
QT_MOC_LITERAL(2, 20, 0)
    },
    "SScriptFrame\0reload\0\0"
};
...
const QMetaObject SScriptFrame::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SScriptFrame.data,
      qt_meta_data_SScriptFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SScriptFrame.stringdata))
