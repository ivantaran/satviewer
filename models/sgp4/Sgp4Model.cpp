...
int Sgp4Model::modelInit(int whichconst, double _jdsatepoch, double _bstar, double _inclo, double _argpo, double _ecco, double _nodeo, double _mo, double _no) {
	/* ------------------------ initialization --------------------- */
...
void Sgp4Model::getgravconst(int whichconst) {
...
int Sgp4Model::model(double tsince) {
...
void Sgp4Model::initl(double epoch) {
    /* --------------------- local variables ------------------------ */
...
double Sgp4Model::gstime(double jdut1) {
...
void Sgp4Model::dscom(double epoch) {
     /* -------------------------- constants ------------------------- */
...
void Sgp4Model::dpper(char init, double ecc, double incl, double node,  double argp, double m) {
     /* --------------------- local variables ------------------------ */
