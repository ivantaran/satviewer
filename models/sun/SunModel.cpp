...
int SunModel::modelInit(int whichconst, double _jdsatepoch, double _bstar, double _inclo, double _argpo, double _ecco, double _nodeo, double _mo, double _no) {
	ecco       = _ecco;
	argpo      = _argpo;
	inclo      = _inclo;
	mo	       = _mo;
...
int SunModel::model(double tsince) {
...
double SunModel::gstime(double jdut1) {
