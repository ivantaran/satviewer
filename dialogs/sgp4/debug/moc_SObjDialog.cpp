...
**
** Created: Sat 25. Aug 14:02:37 2012
...
static const char qt_meta_stringdata_SObjDialog[] = {
    "SObjDialog\0\0setColorSatName()\0"
...
const QMetaObjectExtraData SObjDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SObjDialog::staticMetaObject = {
    { &SAbstractObjDialog::staticMetaObject, qt_meta_stringdata_SObjDialog,
      qt_meta_data_SObjDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SObjDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SObjDialog))
